...
void merge(int data[], int kiri, int tengah, int kanan)
{
    ...
    // Menggabungkan array kiri dan array kanan ke dalam array hasil (array data) dengan cara menyalin elemen data yang nilainya lebih kecil di antara setiap elemen dalam array kiri dan array kanan hingga salah satu antara array kiri atau array kanan elemennya sudah habis disalin.
